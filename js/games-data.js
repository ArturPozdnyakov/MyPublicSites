const games = [
    ...
    },
    {
        ...
        "description": "Однотипная, у ботов тупой ии"
    },
    {
        "title": "Don't Starve",
    ...
    {
        "title": "Only up",
        "image": "https://cdn.cloudflare.steamstatic.com/steam/apps/2842590/header.jpg",
        "myRating": 9.0,
        "steamRating": 7.4,
        "timesCompleted": 1,
        "genres": [
        ...
        "description": "Прошел с чекпоинтами"
    },
    {
        ...
        "description": "Самая заскриптованная игра которую я только видел.\n\nМного лютых багов, 5 фпс катсцены, кривые хитбоксы.\n\nЖдем ремейк, а так это неиграбельный калл исключительно только для истинных фанатов игр серии \"Resident Evil\".\n\nСлишком накрутили фантастики, давно бы уже сдохли и все, но нет нас просто не убивают.\n\nP.S. Не смогли допройти прям в финале потому что чудо-разрабы не подумали что может не быть у игроков патронов, добивать ножом сразу убивает напарника, баг или очередной аутизм разрабов."
    }
];